...
final class SharedData {
  ...
  static final ArrayNode arrayIntJson2 = ObjectMapperInstance.INSTANCE.createArrayNode();
  static final int[] arrayInt =  {1, 2, 3, 4, 5};
  static final int[] arrayInt2 = {6, 7, 8, 9, 10};
  static final ArrayList<Integer> listInt = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5));
  static final ArrayList<Integer> listInt2 = new ArrayList<>(Arrays.asList(6, 7, 8, 9, 10));
  static final HashSet<Integer> setInt = new HashSet<>(Arrays.asList(1, 2, 3, 4, 5));
  final HashSet<Integer> setInt2 = new HashSet<>(Arrays.asList(6, 7, 8, 9, 10));
  ...
  static final LinkedListNode<Integer> linkedListInt2 = new LinkedListNode<>(6,
